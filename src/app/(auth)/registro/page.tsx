...
export default function RegisterPage() {
  ...
  const onSubmit = async (data: RegisterFormValues) => {
    try {
      ...
      toast.success('Conta criada! Faça login com a conta de admin (mock).');
      router.push('/login');
    } catch (error: any) {
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative selection:bg-blue-600 selection:text-white">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="flex justify-center mb-6">
          <div className="w-14 h-14 rounded-2xl bg-slate-900 flex items-center justify-center text-white font-bold text-3xl shadow-lg">
            D
          </div>
        </div>
