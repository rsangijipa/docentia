...
async function main() {
    ...
    const students = [
        { nome: 'Ana Beatriz Silva', matricula: '2026001', turmaId: 'turma-8a' },
        { nome: 'Bruno Oliveira', matricula: '2026002', turmaId: 'turma-8a' },
        { nome: 'Carla Souza', matricula: '2026003', turmaId: 'turma-8a' },
    ];
